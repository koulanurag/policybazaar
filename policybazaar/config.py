...
CASSIE_ENV_IDS = {
    'cassie:CassieWalkSlow-v0': {'wandb_run_path': CASSIE_BASE_PROJECT_URL + '2l2ah4qu', 'models': {1: 0}},
    ...
    'cassie:CassieHop-v0': {'wandb_run_path': CASSIE_BASE_PROJECT_URL + '2u00mtk8', 'models': {1: 0}}}
